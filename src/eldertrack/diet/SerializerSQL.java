...
public class SerializerSQL {
	...
	public static Meals retrieveMeals(int id, SQLObject so) {
		...
		try {
			...
			System.out.println("Serialization version mismatch occured retrieving Meals");
			return null;
		} catch (SQLException e) {
			e.printStackTrace();
			return null;
	...
	public static Nutrition retrieveNutrition(int id, SQLObject so) {
		...
		try {
			...
			System.out.println("Serialization version mismatch occured retrieving Nutrition");
			return null;
		} catch (SQLException e) {
			e.printStackTrace();
			return null;
